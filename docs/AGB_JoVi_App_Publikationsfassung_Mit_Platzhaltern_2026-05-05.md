...
> Publikationsnahe Fassung mit Platzhaltern. Diese Version ist so aufgebaut, dass vor der Veröffentlichung nur noch die offenen Anbieter- und Unternehmensangaben ersetzt werden müssen.

## Ausfüllblatt vor Veröffentlichung

Bitte vor der Nutzung im Store, in der App oder auf einer Website ersetzen:

- Anbieter oder Firma: <<NAME_ODER_FIRMA>>
- Optionaler Rechtsformzusatz: <<RECHTSFORM_ODER_ZUSATZ>>
- Vollständige ladungsfähige Anschrift: <<ANSCHRIFT_VOLLSTAENDIG>>
- Allgemeine Kontakt-E-Mail: <<KONTAKT_EMAIL>>
- Optional: Umsatzsteuer-ID oder weitere Pflichtangaben: <<USt_ODER_PFLICHTANGABEN>>
- Optional: Impressum oder Website: <<IMPRESSUM_ODER_WEBSITE>>
...
<<NAME_ODER_FIRMA>>  
<<RECHTSFORM_ODER_ZUSATZ>>  
<<ANSCHRIFT_VOLLSTAENDIG>>  
E-Mail: <<KONTAKT_EMAIL>>

Weitere Anbieterinformationen können unter folgender Adresse bereitgestellt werden: <<IMPRESSUM_ODER_WEBSITE>>
...
- Änderung externer Dienste oder technischer Rahmenbedingungen
...
Diese Fassung wurde aus dem geprüften Projektstand der App abgeleitet und ist als Platzhalterfassung für die spätere Veröffentlichung vorbereitet.