...
- Zeitstempel der letzten Aktivität im Pro-/Cloud-Modus (z. B. letzte Anmeldung)
...
### 3.8 Externe Inhalte und eingebettete Dienste

Die App nutzt mehrere Dienste von GitHub, Inc. / Microsoft. Der Community-Screen lädt seine Inhalte (Texte, Karten, Video-IDs) von GitHub-Servern nach. Die Online-Versionen der Rechtstexte (AGB, Datenschutzerklärung) werden ebenfalls über GitHub Pages gehostet und über einen Button in der App aufrufbar gemacht. Bei jeder Verbindung zu GitHub-Servern wird technisch bedingt die IP-Adresse Ihres Geräts übertragen. Maßgeblich für alle genutzten GitHub-Dienste ist derselbe Anbieter: GitHub, Inc. / Microsoft.
...
Diese Verbindung wird nicht erst hergestellt, wenn Sie ein Video aktiv abspielen, sondern bereits beim Laden des Community-Screens. Die Datenverarbeitung durch Google und YouTube richtet sich nach den Datenschutzbestimmungen von Google (https://policies.google.com/privacy).
...
Zusätzlich wird das Nutzerprofil (`/users/{uid}`) serverseitig automatisiert gelöscht, wenn seit mindestens
12 Monaten keine Aktivität mehr festgestellt wurde und kein aktives Pro-Abonnement mehr besteht.
Für abgelaufene Abonnements gilt zusätzlich ein technischer Sicherheits-Puffer von 7 Tagen.
