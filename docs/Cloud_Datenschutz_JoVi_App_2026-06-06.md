...
- Authentifizierungs- und Kontodaten wie UID, Anzeigename, E-Mail-Adresse oder Profilbild
- grundlegende Benutzerprofil- und Statusdaten wie Kontoanlage, letzte Aktivität oder verknüpfte Plattform
- technische Sitzungs-, Protokoll- und Sicherheitsdaten zur Stabilisierung und Missbrauchsabwehr
- Metadaten zu Anmeldung, Kontozuordnung, Wiederherstellung oder geräteübergreifender Kontonutzung

## 3. Zwecke der Verarbeitung

Die Verarbeitung erfolgt insbesondere, um:

- eine Anmeldung und geräteübergreifende Nutzung zu ermöglichen
- kontobezogene App-Nutzung über dasselbe berechtigte Benutzerkonto bereitzustellen
- Benutzerkonten technisch zu verwalten und ihren Status aktuell zu halten
- Anmelde-, Aktivitäts- und Sicherheitsereignisse nachvollziehbar zu halten
- Missbrauch, technische Fehler und unberechtigte Zugriffe zu erkennen oder einzugrenzen
- bei freiwilliger späterer Pro-Aktivierung die kontobezogene technische Grundlage bereitzustellen
...
Cloudbezogene Kontodaten werden nur so lange gespeichert, wie dies für Anmeldung, Kontoverwaltung, Sicherheitszwecke, technische Nachvollziehbarkeit oder gesetzliche Pflichten erforderlich ist. Gesonderte Team- oder Pro-Daten richten sich nach den jeweils zusätzlich anwendbaren Pro-Datenschutzhinweisen.

## 7. Freiwilligkeit und Folgen der Nichtzustimmung
