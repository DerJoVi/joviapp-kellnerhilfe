...
- Inaktive Mitglieder werden serverseitig begrenzt; bei Ãœberschreiten eines Grenzwerts können ältere inaktive Mitgliedseinträge entfernt werden.
...
Soweit gesetzliche Aufbewahrungspflichten, laufende Streitfälle oder sonstige überwiegende berechtigte Interessen eine längere Speicherung erfordern, kann die Speicherung im Einzelfall darüber hinausgehen. Im Ãœbrigen sollen diese Daten nach Ablauf der jeweiligen Frist gelöscht oder soweit praktikabel anonymisiert werden.
...
## 13. Ã„nderungen dieser Datenschutzerklärung
